  ...
  return (
    <div className="priority-breakdown">
      ...
      <div className="priority-fact">
        ...
        <strong>{reviewSize.label}</strong>
        <small>{reviewSize.description}</small>
      </div>
      <div className="priority-fact">
        <span>Waiting</span>
        <strong>{waiting.label}</strong>
        <small>Time since this pull request opened</small>
      </div>
    </div>
  );
}
