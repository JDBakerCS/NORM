...
- Manual sync is the MVP update mechanism; webhooks are deferred.
...
| 8 | Optional webhooks and expanded sync capabilities | Deferred |

## Current Progress

The complete MVP code is present. On August 3, 2026, all 26 backend tests passed and the Vite production build completed successfully.

## Remaining Work

- Supply local or Neon `DATABASE_URL`, a strong `JWT_SECRET`, and a fine-grained `GITHUB_TOKEN`.
- Run the explicit schema/seed commands against that database.
